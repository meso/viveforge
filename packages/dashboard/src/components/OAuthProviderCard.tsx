...
export function OAuthProviderCard({ supportedProvider, configuredProvider, onUpdate }: OAuthProviderCardProps) {
  ...
  const getProviderIcon = (provider: string) => {
    const iconComponents = {
      ...
      slack: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
          ...
          <path d="M18.956 8.834a2.528 2.528 0 012.521-2.521A2.528 2.528 0 0124 8.834a2.528 2.528 0 01-2.523 2.521h-2.521V8.834z" fill="#2EB67D"/>
          ...
          <path d="M15.165 18.956a2.528 2.528 0 012.523 2.521A2.528 2.528 0 0115.165 24a2.527 2.527 0 01-2.52-2.523v-2.521h2.52z" fill="#ECB22E"/>
    ...
    return iconComponents[provider as keyof typeof iconComponents] || (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
    ...
    <div class="bg-white border border-gray-200 rounded-lg p-6">
      <div class="flex items-start justify-between mb-4">
        <div class="flex items-center gap-3">
          <div class="w-8 h-8 flex items-center justify-center">{getProviderIcon(supportedProvider.provider)}</div>
          <div>
        ...
        <div class="space-y-3">
          ...
          <div class="text-sm text-gray-600">
            ...
            <p class="mt-1 text-xs text-gray-500">
              Use this URL when configuring your OAuth application with the provider. 
              After authentication, users will be redirected to your app based on the callback URLs you configure in your application settings.
            </p>
          </div>
